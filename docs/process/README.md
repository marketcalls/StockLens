...
| 2026-08-07 | [Checking the numbers](2026-08-07-checking-the-numbers.md) | Eleven faults found by checking the app against the data rather than against its own tests. Nine were the same mistake: a number written down where there was no measurement. |
